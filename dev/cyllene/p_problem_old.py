...
import dev.cyllene.f_define as fd
import dev.cyllene.f_compare as fc
...
"""
Defines a class for basic problem handling
"""
class Problem():
    """
    attributes:
        -- problem type: [solutions choice, ...]
        
        -- problem statement 
        
        -- functions_table ( consists of a nested dictionary for each function)
        
        -- graphs_table (consits of a nested dictionary that contains a g_graph class object)
        
        
    """

    def __init__(self, problem_type, problem_statement, functions_table, graphs_table, *args):

        self.problem_type = problem_type
        self.problem_statement = problem_statement
        self.f_dict = functions_table
        self.graphs_table = graphs_table
