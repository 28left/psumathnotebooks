# want to edit this so that nested functions get expanded out if possible

#  Operators
#  List of standard mathematical operators
unary_operators = ['const', 'step', 'exp', 'trig', 'poly', 'linear',
                   'quadratic', 'cubic', 'sqrt', 'cbrt', 'H', 'S',
                   'neg', 'abs', 'exp', 'log', 'ln',
...
def string_to_list(string):
    '''
    Transforms an input string properly formatted as a
