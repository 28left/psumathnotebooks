...
RANDOM_FUNC_LIST = [
    ...
    ['(1/2)*(x**2)', 'quadratic'], ['3*(x**2)+7*x+1', 'quadratic'],
    ...
    ['2*(x**3)-3*(x**2)+1', 'cubic'], ['x**3+x', 'cubic'],
    ['x**3-8', 'cubic'], ['-2*x^3-3', 'cubic'], ['-4*x^3+1', 'cubic'],
    ['4*(x**3)+2*x+1', 'cubic'], ['-8*x^3+3*x^2+1', 'cubic'],
    ['x**3-4*x+2', 'cubic'], ['-2*x^3+3',
...
# standards = [
#     ['exp(x)', ['positive','increasing','concave up','horizontal asymptote']],
#     ['-exp(x)', ['negative','decreasing','concave down','horizontal asymptote']],
#     ['log(x)', ['increasing','concave down','vertical asymptote']],
#     ['-log(x)', ['decreasing','concave up','vertical asymptote']],
#     ['x', ['increasing','polynomial','linear']],
#     ['-x', ['decreasing','polynomial','linear']],
#     ['x^2', ['non-negative','concave up','polynomial','quadratic']],
#     ['-x^2', ['non-positive','concave down','polynomial','quadratic']]
# ]

# negation_pairs = [["positive","negative"], ["concave up","concave down"], ["non-negative","non-positive"]]
# constant_dependent = ["positive","negative","non-negative","non-positive"]
