...
unary_operators=['H', 'S', 'const', 'exp', 'trig', 'poly', 'linear', 'quadratic', 'cubic', 'quartic', 'quintic', 'sqrt', 'cbrt', 'neg', 'abs', 'log', 'ln', 'sin', 'cos', 'tan', 'sec', 'csc', 'cot', 'arcsin', 'arccos', 'arctan', 'arcsec', 'arccsc', 'arccot']
